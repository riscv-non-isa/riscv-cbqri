...
configure resource usage limits, in the form of capacity or bandwidth, and
optionally a priority for an `RCID` in the resource controllers that control
accesses to such shared resources.
